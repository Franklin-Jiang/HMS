...
export default function ProfileSection() {
  const [profile, setProfile] = React.useState<NurseProfile | null>(null)
  ...
  async function loadProfile() {
    try {
      const response = await fetch('/api/HMS/dashboard/nurse/profile')
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div>
                    ...
                    <div className="font-medium">{profile.NurseID}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    <div className="text-sm text-gray-500 mb-1">班次</div>
                    <div className="font-medium">
                      {profile.Shift === 'morning' ? '早班' :
                       profile.Shift === 'afternoon' ? '午班' : '晚班'}
                    </div>
                  </div>
                </div>
              </div>
